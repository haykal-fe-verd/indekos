...
function EditKamar() {
    const { kategori, kamar } = usePage().props;
    ...
    React.useEffect(() => {
        const initialFoto = kamar.foto_kamar.map((foto) => foto.foto);
        const initialFasilitas = kamar.fasilitas_kamar.map(
            (fasilitas) => fasilitas.nama_fasilitas
        );

        setFoto(initialFoto);
        setImagePreviews(initialFoto);
        setFasilitas(initialFasilitas);

        setData({
            nama_kamar: kamar.nama_kamar,
            luas_kamar: kamar.luas_kamar,
            harga_kamar: kamar.harga_kamar,
            jenis_sewa: kamar.jenis_sewa,
            kategori_id: kamar.kategori_id.toString(),
    ...
    const onSubmit = async (e) => {
        ...
        post(route("kamar.update", kamar.id), formData, {
            onSuccess: () => {
                reset();
            },
        });
                    ...
                    <div className="grid grid-cols-4 gap-5">
                        ...
                        <div className="col-span-4 lg:col-span-2">
                            ...
                            <Select
                                ...
                                defaultValue={kamar.kategori_id.toString()}
                            >
                                <SelectTrigger className="mt-2 bg-white">
                                    ...
                                    <div key={index}>
                                        ...
                                        <div className="flex flex-col items-center space-x-2">
                                            {imagePreviews[index] && (
                                                <div className="">
                                                    <img
                                                        src={`/storage/${imagePreviews[index]}`}
                                                        alt={`Preview${index}`}
